    ...
    <div className="w-full max-w-2xl mx-auto"> 
      ...
      <div className="bg-background-secondary/80 backdrop-blur-md border border-white/10 p-6 sm:p-8 rounded-2xl shadow-lg">
        ...
        <p className="text-gray-300 mb-6">
          ...
          Descrivi il tuo problema nel dettaglio e ti risponderemo il prima possibile.
        </p>

        <a 
          href={`mailto:${supportEmail}`}
          className="inline-flex items-center gap-3 bg-primary text-background-main font-bold px-6 py-3 rounded-lg hover:bg-opacity-90 transition-all text-base"
        >
